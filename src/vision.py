        ...
        while self.running:
            ...
            if path is not None and path_locs is not None:
                ...
                if self.blind_frames < self.max_blind_recovery:
                    ...
                    if self.last_error < 0:
                        self.motion.set_reverse_speed(0.5, Wheel.LEFT)
                        self.motion.set_forward_speed(0.5, Wheel.RIGHT)
                    else:
                        self.motion.set_forward_speed(0.5, Wheel.LEFT)
                        self.motion.set_reverse_speed(0.5, Wheel.RIGHT)
